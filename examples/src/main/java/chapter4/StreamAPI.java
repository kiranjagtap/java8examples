...
public class StreamAPI {
    ...
    public static void main(String... arg) {
       ...
       /* List<String> title = Arrays.asList("a1","a2","a3");
        ...
        skipElementsInStream(menu, 2).forEach(System.out::print);// skip fisrt n elements

        //flattening Stream
        System.out.println("apply function to each element of Stream using map");
        applyFunctionToEachElementOfStreamUsingMap(menu, 2).forEach(System.out::print);// skip fisrt n elements
